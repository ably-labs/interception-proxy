...
class MitmproxyAddon:
    ...
    def request(self, flow: http.HTTPFlow) -> None:
        ...
        # TODO see extended comments re this in test-node.yml in https://github.com/ably/ably-js/pull/1816 and why it hasn’t yet been an issue in practice on macOS
